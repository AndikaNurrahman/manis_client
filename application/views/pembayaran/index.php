                                           ...
                                           <td class="text-center">
                                               ...
                                               <ul class="table-controls">
                                                   ...
                                                   <li>
                                                       ...
                                                       <a href="javascript:();" data-id="<?php echo $baris->tagihan_id; ?> ?>" data-paket="<?php echo $baris->nama_pelanggan; ?>" data-tarif="<?php echo $baris->tarif_inv; ?>" data-nomor="<?php echo $baris->no_pelanggan; ?>" data-toggle="modal" data-target="#edit-data" data-toggle="modal" data-target="#ubah-data" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-check-circle text-primary">
