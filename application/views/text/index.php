                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            ...
                            <div class="chat-system">
                                ...
                                <div class="user-list-box">
                                    ...
                                    <div class="people">
<?php foreach ($inbox->result() as $baris) : ?>
                                        <div class="person" data-chat="person<?php echo $baris->message_id; ?>">
                                            <div class="user-info">
                                                <div class="f-head">
                                                ...
                                                <div class="f-body">
                                                    <div class="meta-info">
                                                        <span class="user-name" data-name="Nia Hillyer"><?php echo $baris->phone; ?></span>
                                                        <span class="user-meta-time"><?php     $sec = strtotime($baris->date);  
    //converts seconds into a specific format  
     echo $newdate = date (" H:i A", $sec);    ?></span>
                                                    </div>
                                                    <span class="preview"> <?php echo $baris->message; ?></span>
                                                </div>
                                            </div>
                                        </div>
  <?php endforeach; ?>
                                    ...
                                    <div class="chat-box-inner">
                                        ...
                                        <div class="chat-conversation-box">
                                            <div id="chat-conversation-box-scroll" class="chat-conversation-box-scroll">
                                                 <?php foreach ($inbox->result() as $baris) : ?>
                                                <div class="chat" data-chat="person<?php echo $baris->message_id; ?>">
                                                    <div class="conversation-start">
                                                        <span><?php     $sec = strtotime($baris->date);  
    //converts seconds into a specific format  
     echo $newdate = date (" H:i A", $sec);    ?></span>
                                                    </div>
                                                    <div class="bubble you">
                                                        <?php echo $baris->message; ?>
                                                    </div>
