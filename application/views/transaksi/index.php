       ...
       <div class="layout-px-spacing">
           ...
           <div class="row layout-top-spacing">
               ...
               <div class="page-header">
                   ...
                   <h3>Transaksi </h3>
                   <td><button class='btn btn-primary' data-toggle='modal' data-target='#exampleModal'>Tambah Pemasukan/Pengeluaran</button> </td>
                           ...
                           <table id="default-ordering" class="table table-hover" style="width:100%">
                               ...
                               <tbody>
                                   ...
                                   <?php foreach ($query->result() as $baris) : ?>
                                       <tr>
                                           <td><?php echo $baris->t_id; ?></td>
                                           <td><?php echo $baris->nama; ?></td>
                                           <td><?php echo $hasil_rupiah = "Rp " . number_format($baris->tarif, 2, ',', '.'); ?></td>

                                           <td class="text-center"><?php if ($baris->keterangan == 'Pemasukan') {
                                                                        echo '<span class="shadow-none badge badge-primary">Pemasukan</span>';
                                                                    } else {
                                                                        echo '<span class="shadow-none badge badge-danger">Pengeluaran</span>';
                                                                    } ?></td>
